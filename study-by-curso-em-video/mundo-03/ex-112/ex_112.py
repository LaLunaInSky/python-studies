#Dentro do pacote utilidadesCeV que criamos no Ex_111, temos um módulo chamado dado. Crie uma função chamada leiaDinheiro() que seja capaz 
...
preçoInformado = moedas.leiaDinheiro(
    '\nQual o preço? R$'
)
